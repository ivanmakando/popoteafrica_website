# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-13 08:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('popoteafrica', '0006_auto_20160913_1112'),
    ]

    operations = [
        migrations.CreateModel(
            name='BookingsForTheSafariIteneary',
            fields=[
                ...
                ('trip_booked', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='popoteafrica.SafariIteneary')),
            ],
        ),
